    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="mt-4 space-y-6">
        ...
        <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-md p-4">
          ...
          <div className="md:ml-6 mt-4 md:mt-0">
            ...
            <p className="text-gray-600">
              Inspirée de la basilique Saint-Pierre de Rome, elle est la plus
              grande basilique du monde et un chef-d'œuvre architectural.
            </p>
          </div>
        </div>
      ...
      <div className="mt-6">
        <p className="text-gray-700 font-semibold">
          {' '}
          Consultez ce guide pour en savoir plus sur le tourisme en Côte
          d'Ivoire :
        </p>
        <a
        ...
        >
          📥 Télécharger le Guide de Voyage.
        </a>
      </div>
